...
#STRING INPUT
string_data = "1000000,2,6,3,79,8,8,8,8,8,8,964511,983931,1664089,891586,927171,961664,873552,1684259,896040,621000,426529,528666"
...
while feature < INPUT_DIMENSION:
    x_in[0, feature] = float(data[feature])
    x_in[0, feature] = (
